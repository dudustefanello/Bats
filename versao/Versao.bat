...
@ %LOGGING% Limpar DCUs 5.0.%2
  @ start /b /wait Clear.bat /i %2

@ %LOGGING% Update Fontes Versao 5.0.%2
  @ start /b /wait Update.bat /i %2

@ %LOGGING% Alterar a Versao nos Projetos da 5.0.%2
  @ start /b /wait Incrementa.bat /i %2

@ %LOGGING% Abrir Delphi e Construir Projetos da 5.0.%2
  @ start /realtime /wait bds -b C:\Fontes\flextotal_5_0_%2\Flex_5.0.%2.groupproj -oC:\Users\eduar\OneDrive\Documentos\Bats\Versao\build.log

@ start /b /wait Compactar.bat /i %2

@ %LOGGING% Copiar Arquivos para Distribuicao
  @ start /b /wait Copiar.bat /i %2

@ %LOGGING% Commit 5.0.%2
  @ start /b /wait Commit.bat /i %2
...
@ %LOGGING% COLAR o Log dos chamados da 5.0.%2
  @ notepad C:\Users\eduar\OneDrive\Documentos\Bats\versao\toCommit%2.txt
